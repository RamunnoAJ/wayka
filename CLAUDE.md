...
Los cuatro primeros son **contrato de producto**, no de implementación: valen igual para el backend y para el frontend, y por eso viven en una sola copia acá. Estuvieron duplicados en los dos repos y divergieron; no volver a copiarlos.
